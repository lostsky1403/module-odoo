# -*- coding: utf-8 -*-
# Part of nuyostech. See LICENSE file for full copyright and licensing details.

{
    "name" : "Pipeline Product to Sales Order | CRM Product to Quotation",
    "version" : "18.0.0.0",  # Update version ke 18.0
    "category" : "Sales",
    ...
    "depends" : ['base','crm','product','account','sale_management','sale_crm', 'purchase'],
    "data": [
